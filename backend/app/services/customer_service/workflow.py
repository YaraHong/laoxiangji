...
async def run_customer_pipeline(
    ...
    #
    builder.add_node("conversation_analysis", conversation_analysis)
    ...
    builder.add_edge("llm_output", "save_message")

    builder.add_edge("save_message", "conversation_analysis")

    builder.add_edge("conversation_analysis", END)
